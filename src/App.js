            ...
            <div className='buttons'>
                <div className="rowOne">
                    <div id='circles'>
                        ...
                        <Circle></Circle>
                        <button onClick={() => setWeekOneCircles([...weekOneCircles, (<Circle></Circle>)])}>+</button>
                    </div>
                    <div id='squares'>
                        <button
                        ...
                        <Square></Square>
                        <button onClick={() => setWeekOneSquares([...weekOneSquares, (<Square></Square>)])}>+</button>
                    </div>
                    <div id='triangles'>
                        <button
                        ...
                        <Triangle></Triangle>
                        <button onClick={() => setWeekOneTriangles([...weekOneTriangles, (<Triangle></Triangle>)])}>+</button>
                    </div>
                </div>
